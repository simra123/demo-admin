  ...
  // },
  {
    ...
    subs: [
      ...
      },
      {
        id: 'pages-product',
        label: 'Subscriber',
        to: `${ adminRoot }/pages/subscribers`,
        icon: 'simple-icon-people',
      },
      {
        id: 'pages-product',
        label: 'Subscription',
        to: `${ adminRoot }/pages/subscription`,
      ...
      },
      {
        id: 'pages-product',
        label: 'ContactUS',
        to: `${ adminRoot }/pages/contactus`,
        icon: 'simple-icon-people',
      },
      {
        id: 'pages-product',
        label: 'Slider',
        to: `${ adminRoot }/pages/slider`,
        icon: 'simple-icon-list',
      },
      {
        id: 'pages-product',
        label: 'Contact Vendor',
        to: `${ adminRoot }/pages/contactvendor`,
        icon: 'simple-icon-bubbles',
      }
      // {
      //   id: 'pages-product',
      //   label: 'States',
      //   to: `${ adminRoot }/pages/states`,
      //   icon: 'iconsminds-left---right-3',
