...
const AddSubscription = ({ isOpen, toggle, setLoading, loading, modalDelete }) => {
    // states
    // strip products
    ...
    // repeating forms
    const [formValues, setFormValues] = useState([{ description: "", valid: false }])
            ...
            <Formik
                ...
                onSubmit={ (value) => {
                    ...
                    const obj = {
                        ...
                        services: formValues,
                        product_id: filteredPackages ? filteredPackages[0]?.product : "",

                    }
                    // post api function
                    PostMethods.PostSubscription(obj)
                        .then(() => {
                            setLoading(false)
                            toggle()
                            setFilteredPackages([])
                            setFormValues([{ description: "", valid: false }])
